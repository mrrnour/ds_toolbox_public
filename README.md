...
| 🤖[`ml_funcs`](dstoolbox/ml_funcs)           | `[ml]`                         | Model templates, training (incl. nested CV), scoring, performance plots (ROC / PR / gain / lift / reliability / confusion), tuning, PCA/CCA, SHAP/PDP/feature importance, multilabel, regression assumption checks, time-series EDA / forecasters / backtest plots. |
