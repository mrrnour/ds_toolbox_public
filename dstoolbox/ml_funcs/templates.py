...
def classifiers_template(y, random_state=10, imputer_strategy="mean", pc_n_components=5):
    ...
    classifiers = {
        ...
        "RandomForest_model_n200": RandomForestClassifier(
            n_estimators=200, random_state=random_state
        ),
        "RandomForest_model_n300": RandomForestClassifier(
        ...
        "MLPClassifier_early_stopping": MLPClassifier(
            alpha=1, max_iter=1000, early_stopping=True, random_state=random_state
        ),
        "MLPClassifier3": MLPClassifier(
            alpha=1, max_iter=1000, solver="sgd", early_stopping=True, random_state=random_state
        ),
...
def regressors_template(random_state=10):
    ...
    Regressors = {
        ...
        "RandomForest_model_n200": RandomForestRegressor(
            n_estimators=200, random_state=random_state
        ),
        "RandomForest_model_n300": RandomForestRegressor(
            n_estimators=300, random_state=random_state
        ),
